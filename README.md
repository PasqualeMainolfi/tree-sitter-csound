...
The completion reference file `csound.json` located in tree-sitter submodule `tree-sitter-csound/csound_data_parse/` folder depends on offcial csound manual repo. To update completion reference, in the same folder run:
